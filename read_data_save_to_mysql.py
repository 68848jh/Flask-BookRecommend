...
User = pd.read_csv(path, engine='python',encoding='ISO-8859-1',sep=None, error_bad_lines=False)
...
Book = pd.read_csv(path, sep=None, error_bad_lines=False,engine='python',encoding='ISO-8859-1')
...
Rating = pd.read_csv(path, sep=None, error_bad_lines=False,engine='python',encoding='ISO-8859-1')
...
Booktuijian = pd.read_csv('data/booktuijian.csv',engine='python',encoding='ISO-8859-1')
